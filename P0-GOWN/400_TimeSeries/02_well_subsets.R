...
# 1) Input
# ---------------------------------------------------------
setwd("/home/gam/github/gownproject/P0-GOWN/400_TimeSeries/10_amplicon/00_groupcounts/00_subset_count")
input_file <- "/home/gam/github/gownproject/P0-GOWN/400_TimeSeries/10_amplicon/00_groupcounts/04_well_presence_absence.csv"
