...
write.csv(rearranged_filtered_combined_amp, paste0(outpath,"/amp_bact_arch_combined_dadaASV.csv"))
...
write.csv(undivided_combined_mtg, paste0(outpath,"/mtg_bact_arch_combined_singlemASV.csv"))
